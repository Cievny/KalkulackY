...
for(const [name,path] of [['Program','/tools/Program/'],['Objednávky','/tools/objednavky/'],['Aorta','/tools/Aorta/'],['Štatistiky','/tools/analytics/'],['Záznamy','/tools/zaznamy/'],['Kontroly','/tools/kontroly/']]){
