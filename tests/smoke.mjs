...
for(const [name,path] of [['RAS','/tools/RAS/'],['AVF','/tools/AVF/'],['VIS','/tools/VIS/'],['Program','/tools/Program/'],['Objednávky','/tools/objednavky/'],['Aorta','/tools/Aorta/'],['Štatistiky','/tools/analytics/'],['Záznamy','/tools/zaznamy/'],['Kontroly','/tools/kontroly/'],['Cesta pacienta','/tools/pacient/']]){
