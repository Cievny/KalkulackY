...
DROP TABLE IF EXISTS evk_vykony   CASCADE;
DROP TABLE IF EXISTS cas_vykony   CASCADE;
DROP TABLE IF EXISTS pevar_vykony CASCADE;
DROP TABLE IF EXISTS evk_followup CASCADE;
