-- ============================================================
-- ⚠️  TVRDÝ RESET – ZMAŽE VŠETKY ULOŽENÉ ZÁZNAMY!
-- Spustiť len ak chceš úplne čistú databázu (testovacie dáta).
-- Najprv dropne tabuľky, potom spusti celý supabase_setup.sql nižšie.
-- ============================================================

DROP TABLE IF EXISTS cz_evk_vykony   CASCADE;
DROP TABLE IF EXISTS cz_cas_vykony   CASCADE;
DROP TABLE IF EXISTS cz_pevar_vykony CASCADE;
DROP TABLE IF EXISTS cz_evk_followup CASCADE;
DROP TABLE IF EXISTS cz_ideas        CASCADE;
